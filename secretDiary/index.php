<?php
	...
	if (array_key_exists('logout',$_GET)){
		session_destroy();
		setcookie("newId","",time()-60*60);
		$_COOKIE["newId"] = "";
		session_start();
	} else if ((array_key_exists('newId',$_SESSION) AND $_SESSION['newId']) OR
				(array_key_exists('newId',$_COOKIE) AND $_COOKIE['newId'])){
...
<?php include("header.php"); ?>
	...
	<p><strong> Store your thoughts permantly and secure</strong> </p>
		...
		<p>Don't have an account? <a style="text-decoration:underline" class="toggleForms">Sign Up</a></p>
		</form>
